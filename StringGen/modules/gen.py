...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@ProCoderZBots"))
        else:
            ...
            await client.join_chat("ProCoderZBots")
    except KeyError:
        pass
    try:
